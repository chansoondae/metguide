...
export function ArtworkCard({ artwork, viewMode, linkTo }: ArtworkCardProps) {
  ...
  if (viewMode === 'list') {
    return (
      <Link
        href={artworkLink}
        className="group flex gap-4 rounded-lg border border-gray-200 bg-white p-4 transition-all hover:shadow-md"
      >
  ...
  return (
    ...
    >
      ...
      <div className="p-4">
        ...
        <p className="mt-1 text-sm text-gray-600">{artwork.artist}</p>
